...
public abstract class Document {
	...
	{
	/*	if (getNumSyllables() == 0 || getNumWords() == 0){
			return  0;
		}

	 */
		double numberSyllables = (double)getNumSyllables();
		double numberWords = (double)getNumWords();
		double numberSentences = (double)getNumSentences();
		double res =  206.835 - 1.015 * (numberWords / numberSentences) -84.6 * (numberSyllables / numberWords);
		return res;
	}
